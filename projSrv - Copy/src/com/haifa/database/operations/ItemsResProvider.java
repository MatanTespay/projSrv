...
public class ItemsResProvider {
	...
	private static final String update_sql = "UPDATE items SET title=?, description=?, image=?, folder_id=? WHERE id=?;";

	private static final String select_sql = "SELECT * FROM  items WHERE id=?;";

	private static final String select_img_sql = "SELECT image FROM  items WHERE id=?;";


	private static final String insert_sql = "INSERT INTO items (id, title, description, image, folder_id) VALUES (?, ?, ?, ?, ?);";

	private static final String delete_sql = "DELETE FROM items WHERE id=?;";

	private static final String delete_all_sql = "DELETE FROM items WHERE folder_id=?;"; // delete  items folder

	private static final String select_all_sql = "SELECT * FROM items WHERE folder_id=?;"; // get items of folder

	public List<Item> getAllItems(Folder folder, Connection conn)
			throws SQLException {
